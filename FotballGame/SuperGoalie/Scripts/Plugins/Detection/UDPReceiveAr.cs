...
{
    public class UDPReceiveAr : MonoBehaviour
    {
        ...
        [SerializeField] private GameManagerAr _GameManager;
...
//            Debug.Log("dataString" + dataString.ToString());
        ...
        //    Debug.Log("root" + root.ToString());
            ...
            _GameManager.ShootAtNormalizedPosition(root.Ball.x, root.Ball.y);
        }
